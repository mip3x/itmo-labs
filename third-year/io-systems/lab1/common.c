...
void putchar(char ch) {
    sbi_call(ch, 0, 0, 0, 0, 0, 0, EXTENSION_CONSOLE_PUTCHAR /* Console Putchar */);
}

long getchar() {
    long getchar_sbi_return;

    do {
        getchar_sbi_return = sbi_call(0, 0, 0, 0, 0, 0, 0, EXTENSION_CONSOLE_GETCHAR).error;
    } while (getchar_sbi_return == -1);

    return getchar_sbi_return;
}
